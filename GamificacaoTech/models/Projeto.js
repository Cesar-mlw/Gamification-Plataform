...
module.exports = class Projeto {
    ...
    static async listar() {
        ...
        await Sql.conectar(async (sql) => {
            lista = await sql.query("select t.nome_tipo_projeto, p.id_projeto, p.fk_ra_usuario, p.fk_id_tipo_projeto, p.nome_projeto, p.terminado_projeto, p.local_projeto, p.descricao_projeto, p.pontos_extra from projeto p, tipo_projeto t where t.id_tipo_projeto = p.fk_id_tipo_projeto");
        });
        return lista;
    }
    ...
    static async obter(id) {
        let lista = null;
        await Sql.conectar(async (sql) => {
            lista = await sql.query("select p.id_projeto, p.nome_projeto, p.terminado_projeto, p.local_projeto, p.descricao_projeto, t.nome_tipo_projeto from projeto p, tipo_projeto t where id_projeto = ? and p.fk_id_tipo_projeto = t.id_tipo_projeto", [id]);
        });
